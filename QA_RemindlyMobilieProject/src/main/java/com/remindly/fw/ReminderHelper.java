...
public class ReminderHelper extends BaseHelper {
    ...
    public void swipeToMonth(String period,
                             String month,
                             int number) {
    ...
    private void swipeUntilNeededYear(String year,
                                      double startPoint,
                                      double stopPoint) {
        while (!getSelectedYear().equals(year)) {
            swipeInElement(By.className("android.widget.ListView"),
    ...
    public String getSelectedYear() {
        return driver
                .findElement(By.id("month_text_view"))
                .getText();
    }
    ...
    public void selectTime(String timeOfDay, int xHour,
                           int yHour, int xMin, int yMin) {
